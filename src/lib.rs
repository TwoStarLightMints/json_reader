...
fn check_is_valid_json(json_token_vec: &Vec<JsonToken>) -> bool {
    ...
    for token in iter {
        match token {
            JsonToken::JsonKey(_) => { num_keys += 1; }
            JsonToken::JsonString(_) => { num_vals += 1; }
            JsonToken::JsonNum(_) => { num_vals += 1; }
            JsonToken::JsonBool(_) => { num_vals += 1; }
            JsonToken::JsonArrBeg => { num_arr_tokens += 1; }
            JsonToken::JsonArrEnd => { num_arr_tokens += 1; }
            JsonToken::JsonObjBeg => { num_obj_tokens += 1; }
            JsonToken::JsonObjEnd => { num_obj_tokens += 1; }
            JsonToken::JsonInvalid => { return false; }
            _ => (),
        }
    }

    // If either of these two values are not even, that means that there is an unclosed object or array
    if num_arr_tokens % 2 != 0 || num_obj_tokens % 2 != 0 { return false; }
    ...
    if num_keys > num_vals + (num_obj_tokens - 2) + num_arr_tokens { return false; }
        ...
        if json_token_vec[i].is_value() && nesting <= 0 {
            ...
            match json_token_vec[i] {
                JsonToken::JsonArrBeg => {
                    new_vec.push(from_json_tokens_to_json_array(&json_token_vec[arr_inds[1]..=arr_inds[arr_inds.len()-2]].to_vec()));
                    nesting += 1;
                }
                JsonToken::JsonObjBeg => {
                    new_vec.push(from_json_tokens_to_json_object(&json_token_vec[obj_inds[0]..=obj_inds[obj_inds.len()-1]].to_vec()));
                    nesting += 1;
                }
        ...
        if json_token_vec[i].is_key() && nesting <= 0 {
            if json_token_vec[i+1].is_value() {
                ...
                match json_token_vec[i+1] {
                    JsonToken::JsonArrBeg => {
                        new_map.insert(key.clone(), from_json_tokens_to_json_array(&json_token_vec[arr_inds[0]..=arr_inds[arr_inds.len()-1]].to_vec()));
                        nesting += 1;
                    }
                    JsonToken::JsonObjBeg => {
                        new_map.insert(key.clone(), from_json_tokens_to_json_object(&json_token_vec[obj_inds[1]..=obj_inds[obj_inds.len()-2]].to_vec()));
                        nesting += 1;
                    }
                    _ => (),
                }
...
pub fn from_json_string(json_string: &String) -> Result<HashMap<String, JsonToken>, InvalidJson> {
    ...
    if !check_is_valid_json(&token_vec) { return Err(InvalidJson);}
...
mod tests {
    ...
    fn reads_basic_json_string_w_key() {
        ...
        assert_eq!(vec![
            JsonToken::JsonObjBeg,
                JsonToken::JsonKey(String::from("string")), JsonToken::JsonString(String::from("Hello, World!")),
    ...
    fn reads_json_string_w_escape_character() {
        ...
        assert_eq!(vec![
            JsonToken::JsonObjBeg,
                JsonToken::JsonKey(String::from("string")), JsonToken::JsonString(String::from("Hell\"o, World!")),
            JsonToken::JsonObjEnd
            ], tokenize_json_string(&json_string));
    }
    ...
    fn reads_basic_json_number() {
        ...
        assert_eq!(vec![
            JsonToken::JsonObjBeg,
                JsonToken::JsonKey(String::from("number")), JsonToken::JsonNum(123),
            JsonToken::JsonObjEnd
            ], tokenize_json_string(&json_string));
    }
    ...
    fn reads_basic_json_bool() {
        ...
        assert_eq!(vec![
            JsonToken::JsonObjBeg,
                JsonToken::JsonKey(String::from("boolean")), JsonToken::JsonBool(true),
            JsonToken::JsonObjEnd
            ], tokenize_json_string(&json_string));
    }
    ...
    fn properly_parse_nested_arr() {
        ...
        assert_eq!(vec![
            JsonToken::JsonObjBeg,
                JsonToken::JsonKey(String::from("nested-array")), JsonToken::JsonString(String::from("does it work?")),
                JsonToken::JsonKey(String::from("arr")),
                    JsonToken::JsonArrBeg,
                        JsonToken::JsonNum(123),
                        JsonToken::JsonArrBeg,
                            JsonToken::JsonNum(321), JsonToken::JsonBool(true),
                        JsonToken::JsonArrEnd,
                        JsonToken::JsonArrEnd,
            JsonToken::JsonObjEnd
            ], tokenize_json_string(&json_string));
    ...
    fn properly_parse_real_example() {
        ...
        assert_eq!(vec![
            JsonToken::JsonObjBeg,
                JsonToken::JsonKey(String::from("key1")), JsonToken::JsonString(String::from("Hello, World!")),
                ...
                JsonToken::JsonKey(String::from("key3")),
                    JsonToken::JsonObjBeg,
                        JsonToken::JsonKey(String::from("nested-obj")), JsonToken::JsonString(String::from("Hello up there!")),
                    JsonToken::JsonObjEnd,
            JsonToken::JsonObjEnd
            ], tokenize_json_string(&json_string));
    }
